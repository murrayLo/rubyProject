...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { coursetitle: @fee.coursetitle, yearlyfee: @fee.yearlyfee } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { coursetitle: @fee.coursetitle, yearlyfee: @fee.yearlyfee } }
