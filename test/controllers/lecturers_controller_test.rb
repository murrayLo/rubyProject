...
class LecturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lecturer" do
    assert_difference('Lecturer.count') do
      post lecturers_url, params: { lecturer: { fname: @lecturer.fname, sname: @lecturer.sname, subject: @lecturer.subject, title: @lecturer.title } }
    end
  ...
  test "should update lecturer" do
    patch lecturer_url(@lecturer), params: { lecturer: { fname: @lecturer.fname, sname: @lecturer.sname, subject: @lecturer.subject, title: @lecturer.title } }
